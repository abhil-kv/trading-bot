...
// NSE Indices rebalances this list semi-annually (effective last trading day of
// March & September). If a constituent changes, just edit this array -
// everything else in the app resolves symbols dynamically against Angel One's
// instrument master, so no other code needs to change.
//
// `symbol` is the bare NSE trading symbol (without the "-EQ" suffix that
// Angel One's instrument master appends for the equity segment).
